      ...
      <div className="relative w-full max-w-sm bg-white border-r border-slate-200 text-slate-800 flex flex-col h-full shadow-2xl z-10 animate-in slide-in-from-left duration-200 font-sans">
        ...
        <div className="p-5 border-b border-slate-200 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-extrabold text-base text-slate-900 leading-tight">Menú del Sistema</h3>
              <p className="text-xs text-blue-600 font-bold">{currentRoleData?.name || 'Usuario'}</p>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          <div>
            <div className="text-xs uppercase font-bold tracking-wider text-slate-500 mb-3 px-2">
              Módulos Disponibles
            </div>
            ...
            <div className="space-y-1.5">
              {currentRole === 'admin' && (
                <>
                  ...
                  >
                    <Workflow className="w-5 h-5 text-blue-600 shrink-0" />
        ...
        <div className="p-4 border-t border-slate-200 space-y-2 bg-slate-50">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-sm font-bold shadow-sm transition cursor-pointer"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-red-50 hover:bg-red-100 text-red-700 border border-red-200 text-sm font-bold transition cursor-pointer"
          >
